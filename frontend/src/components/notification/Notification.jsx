    ...
    return (
        <div className='notification' style={{ display: 'flex', flexDirection: 'row', margin: '3px 0px', alignItems: 'flex-start', padding: '10px 20px' }}>
            ...
            <div className="username" style={{ display: 'flex', flexDirection: 'row', marginLeft: '4px', alignItems: 'center', marginTop: '4px' }}>
                <p style={{ fontSize: '12.99px', marginLeft: '4.2px', color: 'rgba(226, 232, 240, 0.95)', width: '95%' }}><Link to={`/${user?.username}`} style={{ fontWeight: 'bold', marginRight: '5px' }}>{user?.username}</Link>{content && content}</p>
            ...
            {
                followbtn && <button style={{ border: 'none', outline: 'none', background: 'linear-gradient(135deg, rgb(59, 130, 246) 0%, rgb(139, 92, 246) 100%)', padding: '1px 5px', borderRadius: '8px', color: 'white', fontSize: '13px', width: '65px', fontWeight: 'bold', marginLeft: 'auto', height: '30px', boxShadow: '0 2px 8px rgba(59, 130, 246, 0.3)', transition: 'all 0.2s' }}>Follow</button>
            }
            {
