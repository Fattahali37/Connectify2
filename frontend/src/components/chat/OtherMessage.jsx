    ...
    return (
        msg.message === "like_true" ?
            <div className="other_partytext" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginTop: '18px', }}>
                ...
                <div className="other_text" style={{ width: 'fit-content', marginLeft: '12px', color: 'var(--text-primary)', padding: '10px 16px', borderRadius: '22px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '22px' }}>
            ...
            msg.file ?
                <div className="other_partytext" style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', marginTop: '18px', }}>
                    ...
                    <div className="other_text" style={{ width: 'fit-content', marginLeft: '12px', color: 'var(--text-primary)', padding: '10px 16px', borderRadius: '22px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '22px' }}>
                        <img style={{ maxWidth: '400px', borderRadius: '14px', border: '1px solid var(--border)', marginLeft: '-8px' }} src={msg.message} alt="img" />
                    </div>
                </div>
                :
                <div className="other_partytext" style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', marginTop: '18px', }}>
                    ...
                    <div className="other_text" style={{ width: 'fit-content', marginLeft: '12px', backgroundColor: 'var(--bg-tertiary)', color: 'var(--text-primary)', padding: '10px 16px', borderRadius: '22px', maxWidth: '60%' }}>
                        {msg.message}
                    </div>
                </div>
    )
