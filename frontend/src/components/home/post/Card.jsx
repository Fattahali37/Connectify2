    ...
    <div style={{ position: "relative" }}>
      <div className="card" onClick={() => setEmojiPicker(false)}>
        ...
        <div className="post" style={{ zIndex: "99" }}>
          <img
            style={{ width: "100.20%", marginLeft: "-0.92px", margin: "auto" }}
            src={img}
            alt=""
          />
        </div>
        ...
        >
          ...
          <p style={{ fontSize: "13.19px", marginLeft: "5px" }}>
        ...
        {commnetsCount !== 0 && (
          ...
          >
            <p
              style={{ fontSize: "13.39px", marginLeft: "9px", color: "gray" }}
            >
        ...
        <div className="timestamp" style={{ marginTop: "7px" }}>
          <p style={{ fontSize: "12.89px", marginLeft: "9px", color: "gray" }}>
            <ReactTimeAgo date={Date.parse(time)} locale="en-US" />
          </p>
        </div>
        <div
