...
export default function ViewBox({ stories }) {
  ...
  useEffect(() => {
    if (!stories) return;
    api
      .get(`${url}/user/get/${stories?.current?.owner}`)
      .then((res) => {
        setUser(res.data);
  ...
  return (
    <div
      style={{
        ...
        top: "2.75vh",
        boxShadow:
          "0 0 200px rgba(0,0,0,0.9) inset, 0 8px 32px rgba(0, 0, 0, 0.3)",
    ...
    >
      ...
      >
        ...
        <div
          className="rightSide_header_story"
          style={{
            display: "flex",
            flexDirection: "row",
            alignItems: "center",
      ...
      >
        ...
        <div
          className="input_story_reactions"
          style={{
            display: "flex",
            flexDirection: "row",
            alignItems: "center",
