                    ...
                    ok ?
                        <div style={{ display: 'flex', alignItems: 'center', width: '100%', justifyContent: 'center', height: '90vh' }}>
                            <div className="forgot-box border">
                                ...
                                <button style={{ border: 'none', outline: 'none', background: 'linear-gradient(135deg, rgb(59, 130, 246) 0%, rgb(139, 92, 246) 100%)', padding: '9px 9px', borderRadius: '8px', color: 'white', marginTop: '28px', fontSize: '13px', width: '80%', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(59, 130, 246, 0.3)', transition: 'all 0.2s' }} onClick={() => handleNewPassword()}>Reset Password</button>
                            </div>
                        </div>
