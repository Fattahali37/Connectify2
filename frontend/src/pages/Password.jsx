...
export function Password() {
  ...
  function handleNewPassword() {
    if (!password || !confirmPassword)
      return context.throwErr("All credentials required");
    if (password !== confirmPassword)
      return context.throwErr(
        "New Password and Confirm new password doesn't match"
      );
    api
      .post(`${url}/user/newpassword`, {
        token,
        password,
      })
      .then((res) => {
      ...
      {loading ? (
        ...
        >
          <div className="forgot-box border">
            ...
            >
              Your password must be atleast 6 characters and should include a
